...
SSML_FILE = "../ssml/50_PrayerAnsweredAndUnanswered.ssml"
...
if not api_key:
    print("Usage: python generate_50.py YOUR_GOOGLE_TTS_API_KEY")
...
output_file = "50_PrayerAnsweredAndUnanswered.mp3"
