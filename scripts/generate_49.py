...
SSML_FILE = "../ssml/49_TheWashingOfWaterByTheWord.ssml"
...
if not api_key:
    print("Usage: python generate_49.py YOUR_GOOGLE_TTS_API_KEY")
...
output_file = "49_TheWashingOfWaterByTheWord.mp3"
