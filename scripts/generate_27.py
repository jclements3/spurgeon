...
SSML_FILE = "../ssml/27_TheLoveWithoutMeasureOrEnd.ssml"
...
if not api_key:
    print("Usage: python generate_27.py YOUR_GOOGLE_TTS_API_KEY")
...
output_file = "27_TheLoveWithoutMeasureOrEnd.mp3"
