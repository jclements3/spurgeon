...
SSML_FILE = "../ssml/45_BoldnessAtTheThroneOfGrace.ssml"
...
if not api_key:
    print("Usage: python generate_45.py YOUR_GOOGLE_TTS_API_KEY")
...
output_file = "45_BoldnessAtTheThroneOfGrace.mp3"
